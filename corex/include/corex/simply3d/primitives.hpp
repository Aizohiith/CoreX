...
#if INCLUDE_GLEW == 1
#if INCLUDE_SIMPLY3D_PRIMITIVES == 1
#include <GL/glew.h>
#include <vector>
...
namespace CoreX
{
		...
		namespace Primitives
		{
			class Primitive
			{
				public:
					...
					{
						garr_Vertices.assign(Vertices.begin(), Vertices.end());
						garr_Indices.assign(Indices.begin(), Indices.end());
					}
					...
					const std::vector<float>& Vertices() { return garr_Vertices; };
					const std::vector<unsigned int>& Indices() { return garr_Indices; };
			...
			Primitive  Triangle({ 0.0f, 1.0f, 0.0f, -0.866f, -0.5f, 0.0f, 0.866f, -0.5f, 0.0f }, {0, 1, 2});
            Primitive Cube(
            {
                // Front face
                ...
                // Repeat vertices for proper face orientation (per face)
                // Left face
                -0.5f, -0.5f, -0.5f,
                -0.5f,  0.5f, -0.5f,
                -0.5f,  0.5f,  0.5f,
            ...
            // Indices of the cube (12 triangles, 36 indices)
            {
                // Front face
                0, 1, 2,
                0, 2, 3,
            ...
            Primitive Pentagon({
                ...
                -0.475f, 0.154f, 0.0f, // Upper-left vertex
                -0.293f, -0.404f, 0.0f, // Bottom-left vertex
                0.293f, -0.404f, 0.0f,  // Bottom-right vertex
                0.475f, 0.154f, 0.0f   // Upper-right vertex
                }, { 0, 1, 2, 0, 2, 3, 0, 3, 4 });

            // Hexagon Primitive
            Primitive Hexagon({
                0.0f, 0.5f, 0.0f,   // Top
                -0.433f, 0.25f, 0.0f, // Upper-left
                -0.433f, -0.25f, 0.0f, // Lower-left
                0.0f, -0.5f, 0.0f,   // Bottom
                0.433f, -0.25f, 0.0f,  // Lower-right
                0.433f, 0.25f, 0.0f   // Upper-right
    ...
    ,-0.180240,0.980785,-0.074658
    ,-0.353553,0.923880,-0.146447
    ,-0.513279,0.831470,-0.212607
    ,-0.653281,0.707107,-0.270598
    ,-0.768177,0.555570,-0.318190
    ,-0.853553,0.382683,-0.353553
    ,-0.906127,0.195090,-0.375330
    ,-0.923878,0.000000,-0.382683
    ,-0.906127,-0.195090,-0.375330
    ,-0.853553,-0.382683,-0.353553
    ,-0.768177,-0.555570,-0.318190
    ,-0.653281,-0.707107,-0.270598
    ...
    ,-0.180240,-0.980785,-0.074658
    ,-0.162212,0.980785,-0.108386
    ,-0.318189,0.923880,-0.212607
    ,-0.461939,0.831470,-0.308658
    ,-0.587938,0.707107,-0.392847
    ,-0.691341,0.555570,-0.461940
    ,-0.768177,0.382683,-0.513280
    ,-0.815493,0.195090,-0.544895
    ,-0.831468,0.000000,-0.555570
    ,-0.815493,-0.195090,-0.544895
    ,-0.768177,-0.382683,-0.513280
    ,-0.691341,-0.555570,-0.461940
    ,-0.587938,-0.707107,-0.392847
    ...
    ,-0.392847,0.831470,-0.392847
    ,-0.500000,0.707107,-0.500000
    ,-0.587937,0.555570,-0.587938
    ,-0.653281,0.382683,-0.653281
    ,-0.693519,0.195090,-0.693520
    ,-0.707106,0.000000,-0.707106
    ,-0.693519,-0.195090,-0.693520
    ,-0.653281,-0.382683,-0.653281
    ,-0.587937,-0.555570,-0.587938
